...
**Deferred (not yet built):** PWA/service worker (next-pwa), routines/templates UI, body measurements & photos, drag-to-reorder exercises (Motion `Reorder`), react-hook-form, fully offline (vendored) exercise images.